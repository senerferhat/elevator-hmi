...
| **Phase 2 Qt image (2026-08-18)** | ✅ **HMI RENDERS ON GLASS** — but via **`linuxfb` + software rendering, NOT EGLFS/Mali**. Flash `images-archive/qt-hmi-linuxfb.wic` SHA `e202c6bce9705ac043fa5f4b3169b9294f39b066c7c62d78a0e8ee133ff494ed`. Kernel still 0021-only. |
