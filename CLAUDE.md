...
| **Phase 2 Qt image (2026-08-18)** | ✅ **HMI RENDERS ON GLASS** via **`linuxfb` + software**, not EGLFS/Mali (BLK-015). Current flash: `images-archive/qt-hmi-layouts.wic` SHA `92c19eeb6ec57952af1a33ba4702bdc62e4274a3f89e8cd8fa621128116eb502` — HTML vertical demo, `hmi car`/`hmi video`. |
