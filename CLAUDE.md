...
| **Phase 2 Qt image (2026-08-18)** | ✅ **`elevator-hmi-image` built** (public Qt 6.8.3 + Mali EGLFS + QML mockup). Flash `images-archive/qt-hmi.wic` SHA `06a9f623c66239461bf8718b9d19390f8b3893b061aa903178308cd3ffe0a768`. Glass confirmation pending. Kernel still 0021-only. |
