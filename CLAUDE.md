...
| **Phase 2 Qt image (2026-08-18)** | ✅ **HMI RENDERS ON GLASS** via **`linuxfb` + software**, not EGLFS/Mali (BLK-015). Four layouts installed (portrait / portrait-video / landscape / landscape-video). Landscape is a 1280×800 stage rotated onto the native 800×1280 framebuffer (`hmi rot 90\|270`). Switch with `hmi`. Video panes stay empty until the SD-player task (BLK-015). Flash target: see newest `diary/SESSION-LOG.md`. |
